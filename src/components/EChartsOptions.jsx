    ...
    const echartsOption = {
        ...
        dataset: [
            {
                ...
                source: [
                    ...
                    [geneData.nerve_1, geneData.nerve_2, geneData.nerve_3, geneData.nerve_4],
                    [geneData.muscle_1, geneData.muscle_2, geneData.muscle_3, geneData.muscle_4],
                    [geneData.heart_1, geneData.heart_2, geneData.heart_3, geneData.heart_4],
                    [geneData.hepato_1, geneData.hepato_2, geneData.hepato_3, geneData.hepato_4],
                    [geneData.gut_1, geneData.gut_2, geneData.gut_3, geneData.gut_4],
                    [geneData.ovary_1, geneData.ovary_2, geneData.ovary_3, geneData.ovary_4],
                    [geneData.gonad_1, geneData.gonad_2, geneData.gonad_3, geneData.gonad_4],
        ...
        series: [
            ...
            },
            {
                ...
                type: "scatter",
                data: [
                    [tissues[0], geneData.eye_1], [tissues[0], geneData.eye_2], [tissues[0], geneData.eye_3], [tissues[0], geneData.eye_4],
                    [tissues[1], geneData.gill_1], [tissues[1], geneData.gill_2], [tissues[1], geneData.gill_3], [tissues[1], geneData.gill_4],
                    [tissues[2], geneData.nerve_1], [tissues[2], geneData.nerve_2], [tissues[2], geneData.nerve_3], [tissues[2], geneData.nerve_4],
                    [tissues[3], geneData.muscle_1], [tissues[3], geneData.muscle_2], [tissues[3], geneData.muscle_3], [tissues[3], geneData.muscle_4],
                    [tissues[4], geneData.heart_1], [tissues[4], geneData.heart_2], [tissues[4], geneData.heart_3], [tissues[4], geneData.heart_4],
                    [tissues[5], geneData.hepato_1], [tissues[5], geneData.hepato_2], [tissues[5], geneData.hepato_3], [tissues[5], geneData.hepato_4],
                    [tissues[6], geneData.gut_1], [tissues[6], geneData.gut_2], [tissues[6], geneData.gut_3], [tissues[6], geneData.gut_4],
                    [tissues[7], geneData.ovary_1], [tissues[7], geneData.ovary_2], [tissues[7], geneData.ovary_3], [tissues[7], geneData.ovary_4],
                    [tissues[8], geneData.gonad_1], [tissues[8], geneData.gonad_2], [tissues[8], geneData.gonad_3], [tissues[8], geneData.gonad_4],
                    [tissues[9], geneData.juv_1], [tissues[9], geneData.juv_2], [tissues[9], geneData.juv_3], [tissues[9], geneData.juv_4],
                ],
                colorBy: "data",
            }
        ],
